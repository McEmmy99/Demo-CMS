...
$user_role_count = mysqli_num_rows($user_role_query);
...
?>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
$element_text = ['Active Posts', 'Draft Posts', 'Categories', 'All Users', 'Subscribers', 'Pending Comments', 'All Comments'];
$element_count = [$post_count, $draft_post_count, $category_count, $users_count,  $user_role_count, $unapproved_comment_count, $comment_count];
